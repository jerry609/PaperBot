...
def main() -> int:
    ...
    parser.add_argument("--workspace-id", default=None, help="Optional workspace/project namespace")
    ...
    parser.add_argument("--actor-id", default="cli", help="Audit actor id")
    ...
    created, skipped, _ = store.add_memories(
        user_id=args.user_id,
