...
Current dashboard layout is organized as a daily brief: hot picks, trend radar, and a decision rail, with the full workflow console moved back to `/workflows`.
