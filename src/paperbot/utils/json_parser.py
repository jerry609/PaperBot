...
来源: BettaFish/ReportEngine/utils/json_parser.py
适配: PaperBot 学者追踪系统
...
def parse_json(
    ...
    return _default_parser.parse(
        ...
        extract_wrapper_key=extract_wrapper_key,
    )
...
def safe_parse_json(
    ...
    """
    try:
        return _default_parser.parse(raw_text, context_name=context_name)
    except JSONParseError as e:
        logger.warning(f"{context_name} 解析失败，使用默认值: {e}")
